...
## 📌 Project Overview
![Dashboard Preview](new_dashboard.png)
...
- Yearly sales and quantity trends
- Customer performance
- Returned orders and their impact on sales

## 📁 Project Files

- `Sales_Analysis_Dashboard.xlsx` — Main Excel dashboard and analysis.
